...
<form action="<?= $params['router']->generateUrl('fields_update', ['exercise' => $params['exercise']->getId(), 'field' => $params['field']->getId()]); ?>" accept-charset="UTF-8" method="post">
    <div class="field">
    ...
    <div class="field">
        ...
        <select name="field[value_kind]" id="field_value_kind" onchange="enableElement('submit')">
            <option
                <?php if ($params['field']->getValueKind() == 'single_line'): ?>
                    selected="selected"
                <?php endif; ?>
                    value="single_line"
            >
            ...
            <option
                <?php if ($params['field']->getValueKind() == 'single_line_list'): ?>
                    selected="selected"
                <?php endif; ?>
            ...
            <option
                <?php if ($params['field']->getValueKind() == 'multi_line'): ?>
                    selected="selected"
                <?php endif; ?>
                    value="multi_line"
            >
